    ...
    return (
        <>
            <button
                ...
                className="discount-tab-button bg-gray-100 text-blue font-bold text-xs tracking-wider uppercase py-2 px-4 rounded-b-lg shadow-lg hover:bg-gray-600 transition-colors"
            >
                Obtén 10% de dcto!
            </button>
